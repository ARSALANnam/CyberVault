...
public class CyberVault extends JFrame {
    ...
    public static ui.panels.TokensPanel tokensPanel;
    ...
    void buildFrame() {
        ...
        if (manager.active != null) {
            ...
            if (tokensPanel != null) tokensPanel.refreshTokens();
            updateStats();
    ...
    JPanel buildAppScreen() {
        ...
        tokensPanel = new ui.panels.TokensPanel();
        contentHolder.add(tokensPanel, "TOK");
    ...
    JPanel buildSidebar() {
        ...
        txts.add(label("v1.7.0 // SECURE", ThemeManager.F_MONO_S, ThemeManager.TXT_DIM));
